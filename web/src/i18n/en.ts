export const en: Record<string, string> = {
  ...
  'jlocal.modalTitle': 'jlocal, the tiny app',
  'jlocal.modalGuide': 'A light app that lives on your PC and makes juntos better. Nothing changes on the site: it only shows up when you want it.',
  'jlocal.perkQuality': 'Screen up to 4K at 60 fps, in H.264 on your PC’s hardware',
  'jlocal.perkSound': 'System sound along with the screen, even on macOS',
  'jlocal.perkTorrent': 'Torrents downloading straight on your PC, never through the server',
  ...
  'jlocal.otherSystems': 'Other systems',
  'jlocal.waiting': 'Waiting for the app to show up',
  'jlocal.connectedNow': 'Connected',
  'jlocal.modalOptional': 'Not required: without the app, everything keeps working in the browser.',
