export const ptBR: Record<string, string> = {
  ...
  'onboard.own.body': 'Um arquivo do seu computador, um link magnet ou a sua tela. O torrent é baixado pelo servidor, não pelo seu navegador, então a sala começa sem esperar o download inteiro e ninguém depende da sua conexão.',
